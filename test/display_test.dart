...
main() {
  ...
  group('Display', () {
    ...
    group('Display', () {
      ...
      test('text()', () async {
        disp.text('jtmcdole');
        verify(proto.write(5, 'jtmcdole'.codeUnits));
      });
      ...
      test('bitmap()', () {
        ...
        when(proto.write(any, any)).thenReturn(new Future.value(true));

        disp.bitmap(5, 10, width, height, 48879, bits);
        verify(proto.write(
            15, [0, 5, 0, 10, 0, 20, 0, 15, 0xbe, 0xef]..addAll(bits)));
        ...
        verify(proto.write(
            17, [0, 5, 0, 10, 0, 20, 0, 15, 0xbe, 0xef]..addAll(bits)));
        ...
        verifyInOrder([
          proto.write(
              17,
              [0, 5, 0, 10, 0, 20, 0, 16, 0xbe, 0xef]
                ..addAll(bits.take(16 * 3))),
          proto.write(
              17,
              [0, 5, 0, 26, 0, 20, 0, 4, 0xbe, 0xef]
